...
public class MainClass {
	...
	public static void main(final String[] args) {
		...
		employeeWithoutComparable[0] = new EmployeeWithoutComparable(10,
				"Mikey", 25, 10000);
		employeeWithoutComparable[1] = new EmployeeWithoutComparable(20,
				"Arun", 29, 20000);
		employeeWithoutComparable[2] = new EmployeeWithoutComparable(5, "Lisa",
				35, 5000);
		employeeWithoutComparable[3] = new EmployeeWithoutComparable(1,
				"Pankaj", 32, 50000);
		...
		employeeWithComparable[0] = new EmployeeWithComparable(10, "Mikey", 25,
				10000);
		employeeWithComparable[1] = new EmployeeWithComparable(20, "Arun", 29,
				20000);
		employeeWithComparable[2] = new EmployeeWithComparable(5, "Lisa", 35,
				5000);
		employeeWithComparable[3] = new EmployeeWithComparable(1, "Pankaj", 32,
				50000);
		...
		Arrays.sort(employeeWithComparable,
				EmployeeWithComparable.SalaryComparator);
		...
		Arrays.sort(employeeWithComparable,
				EmployeeWithComparable.AgeComparator);
		...
		Arrays.sort(employeeWithComparable,
				EmployeeWithComparable.NameComparator);
		System.out.println("Employees list sorted by Name:\n"
				+ Arrays.toString(employeeWithComparable));
		System.out.println();

		// Employees list sorted by ID and then name using Comparator class
		employeeWithComparable[0] = new EmployeeWithComparable(1, "Mikey", 25,
				10000);
